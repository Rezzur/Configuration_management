...
6. Реализовать логирование событий вызова команд в файле формата XML.
Событие лога дополнительно содержит:
– Имя пользователя.
7. Стартовый скрипт для выполнения команд эмулятора: поддерживает
...
8. Сообщить об ошибке во время исполнения стартового скрипта.
...
Включить в каждый скрипт вызовы эмулятора для тестирования работы c различными вариантами VFS (минимальный, несколько файлов, не менее 3
...
2. Реализовать новые команды: whoami, rev, head.
